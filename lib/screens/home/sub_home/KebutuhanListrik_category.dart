...
class kebutuhanListrikCategory extends StatefulWidget {
  const kebutuhanListrikCategory({Key? key}) : super(key: key);

  @override
  _KebutuhanListrikCategoryState createState() =>
      _KebutuhanListrikCategoryState();
}

class _KebutuhanListrikCategoryState extends State<kebutuhanListrikCategory> {
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            final filteredPosts = posts
                .where(
                    (post) => post.category.toLowerCase() == 'kebutuhan-listrik')
                .toList();
