...
class KegiatanSosialCategory extends StatefulWidget {
  const KegiatanSosialCategory({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _KegiatanSosialCategoryState createState() => _KegiatanSosialCategoryState();
}

class _KegiatanSosialCategoryState extends State<KegiatanSosialCategory> {
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            final filteredPosts = posts
                .where(
                    (post) => post.category.toLowerCase() == 'kegiatan-sosial')
                .toList();
