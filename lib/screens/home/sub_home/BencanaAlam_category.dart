...
class BencanaAlamCategory extends StatefulWidget {
  const BencanaAlamCategory({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _BencanaAlamCategoryState createState() => _BencanaAlamCategoryState();
}

class _BencanaAlamCategoryState extends State<BencanaAlamCategory> {
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            final filteredPosts = posts
                .where((post) => post.category.toLowerCase() == 'bencana-alam')
                .toList();
